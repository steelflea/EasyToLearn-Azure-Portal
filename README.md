...
> + Azure 무료 체험 계정을 사용할 경우, 마이크로소프트의 체험 계정 정책에 따라 사용할 수 있는 리소스의 할당량이 바뀔 수 있습니다. 할당량이 줄어들 경우 무료 체험 계정으로 책의 모든 실습을 동일하게 진행하지 못할 수 있습니다. 이 경우 이 책의 정오표 파일에 가능한 실습 순서를 안내하겠습니다.
